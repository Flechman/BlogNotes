...
![Example execution diagram](images/example_exec_diagram.png)
...
![Example of valid regular execution but invalid atomic execution](images/valid_regular_invalid_atomic.png)
...
![Multivalue MRSW Regular but not Atomic, using Binary MRSW Regular](images/reg_notAtom_binToMulti.png)
...
![Snapshot naive implementation invalid scenario](images/snapshot_naive_invalid.png)
...
![Two-phase locking unlock after operation wrong](images/twophase_locking_wrong.png)
